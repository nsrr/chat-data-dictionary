...
class DictionaryTest < Test::Unit::TestCase
  ...
  VALID_UNITS = ['decibels','celsius','beats per minute','millimeters of mercury','centimeters','','percent','mmHG','months','years','lbs','pounds','oz','ounces','inches','Ft','feet',"kg",'kilograms','hours','days','minutes','seconds','time'] #Example ['mmHG','bpm','readings','minutes','%','hours','MET']
