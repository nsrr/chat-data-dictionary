...
class DictionaryTest < Test::Unit::TestCase
  ...
  VALID_UNITS = ['millimeters of mercury','centimeters','','cm','%','mmHG','months','years','lbs','pounds','oz','ounces','inches','Ft','feet',"kg",'kilograms','hours','days','minutes','time'] #Example ['mmHG','bpm','readings','minutes','%','hours','MET']
